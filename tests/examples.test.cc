...
TEST_CASE("examples") {
    ...
    auto halt = std::make_shared<Instruction>(instruction_code::hlt,
    ...
    SECTION("example 01: mov, add, mov") {
        ...
        // add [0x8], dl
        auto i4 = std::make_shared<Instruction>(
            instruction_code::add,
            std::vector<operand_ptr>{
        ...
        // mov bh, [0x8]
        auto i5 = std::make_shared<Instruction>(
            instruction_code::mov,
            std::vector<operand_ptr>{
        ...
        program.add_data(std::vector<uint8_t>{0, 1, 2, 3, 4, 5, 6, 7, 1, 1, 1,
                                              1, 1, 1, 1, 1, 1});
    ...
    SECTION("example 02: lea") {
        ...
        auto i3 = std::make_shared<Instruction>(
            ...
            std::vector<operand_ptr>{
                ...
                std::make_shared<MemoryOperand>(register_code::ax, 0, 8,
                                                register_code::ds)},
            8);
    ...
    SECTION("example 03: push") {
        ...
        auto i3 = std::make_shared<Instruction>(
            ...
            std::vector<operand_ptr>{
                ...
                std::make_shared<MemoryOperand>(register_code::rsp, 0, 16,
                                                register_code::ss)},
            16);
    ...
    SECTION("example 05: jmp") {
        ...
        auto i2 = std::make_shared<Instruction>(
            ...
            std::vector<operand_ptr>{std::make_shared<ImmediateOperand>(8)});
    ...
    SECTION("example 08: call + ret") {
        std::vector<instruction_ptr> instructions{
            ...
            std::make_shared<Instruction>(instruction_code::ret,
                                          std::vector<operand_ptr>{}, 64),
